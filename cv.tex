...
{} {
\headedsection{{}}{}{
\bodytext{This document is written in \href{https://www.latex-project.org/}{\LaTeX{}} and hosted in \href{https://www.github.com/aaronmurniadi/cv}{GitHub}. The deployment utilizes GitHub's \textit{Action} feature as part of Continuous Deployment system (the practice of using automation to publish and deploy software update). For every commit to the git repository, the build for this document will be triggered and deployed as a new release.
}}
}
