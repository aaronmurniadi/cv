...
{\dotfill\textsc{Full Time (Jan 2023--\textit{Present})}} {
    ...
    {\bodytext{
    \begin{itemize}
        \item Working as a \textit{Hybrid} tester that can do manual testing alongside automation testing and work based on business focused priority.
        \item Developed and maintained automation regression tests in Java, including API testing with \href{https://rest-assured.io/}{REST Assured} and \href{https://square.github.io/okhttp/}{OkHttp} library, Web front-end testing using \href{https://www.selenium.dev/documentation/webdriver/}{Selenium WebDriver}, as well as Android testing using \href{https://github.com/appium/appium-flutter-driver}{Appium Flutter Driver}. The integrated test runner for all the above automation tasks was \href{https://github.com/cucumber/cucumber-jvm}{Cucumber-JVM}.
        ...
        \item Assisted in integrating OpenAPI generated API clients which are used in production into the automation framework in QA environment.
    \end{itemize}
    }}
...
\footnotesize\noindent
    ...
    \href{https://github.com/aaronmurniadi/cv/releases/latest/download/aaron_murniadi_cv.pdf}
    {https://github.com/aaronmurniadi/cv/releases/latest/download/aaron\_murniadi\_cv.pdf}
}
\end{document}
